...
const TechNav = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 px-3 sm:px-6 py-3 sm:py-4 flex justify-center pointer-events-none">
            <div className="max-w-3xl w-full bg-neutral-950/80 border border-white/15 backdrop-blur-xl pointer-events-auto px-5 sm:px-8 py-2.5 flex items-center justify-between rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
