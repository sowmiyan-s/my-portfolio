...
const TargetCursor: React.FC<TargetCursorProps> = ({
  targetSelector = 'a, button, [role="button"], input, select, textarea, .cursor-target, .magic-bento-card, .contact-card-container, .project-card, .card, article, [data-cursor-target], .group, .clickable, .cursor-pointer',
  spinDuration = 2,
