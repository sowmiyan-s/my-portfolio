  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.937, 0.267, 0.267]) },
        uPulseColor: { value: new Float32Array([0.972, 0.443, 0.443]) },
        uTunnelColor: { value: new Float32Array([0.498, 0.114, 0.114]) },
