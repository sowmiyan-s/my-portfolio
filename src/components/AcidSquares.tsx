...
const AcidSquares: React.FC<AcidSquaresProps> = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uSteps: { value: 32 },
        uColor1: { value: new Float32Array([0.937, 0.267, 0.267]) },
        uColor2: { value: new Float32Array([0.972, 0.443, 0.443]) },
  ...
  return <div ref={containerRef} className={`acid-squares-container ${className}`.trim()} style={style} />;
};
