...
const Hero = () => {
    ...
    return (
        <section id="home" ref={containerRef} className="relative min-h-screen flex items-center justify-start pt-24 pb-12 px-4 sm:px-8 md:px-16 overflow-hidden z-10 w-full bg-transparent">
            ...
            <motion.div 
                ...
                className="max-w-7xl w-full flex flex-col items-start gap-6 md:gap-12 relative z-20 mt-4 md:mt-16"
            >
                <div className="flex flex-col items-start gap-4 md:gap-6 w-full text-left">
                    <div className="relative w-fit max-w-full inline-block overflow-hidden">
                        <h1 
                            onClick={handleTitleClick}
                            className="inline-block text-[clamp(2rem,7.5vw,8rem)] font-heading font-black leading-[1.05] tracking-tighter text-white uppercase break-words sm:whitespace-nowrap drop-shadow-[0_0_25px_rgba(255,255,255,0.3)] cursor-pointer select-none"
                        >
                    ...
                    <div className="w-full max-w-2xl flex flex-wrap justify-start items-center gap-2 md:gap-3 text-[10px] md:text-sm font-mono uppercase tracking-[0.1em] md:tracking-[0.25em] text-red-500 font-bold border border-white/10 bg-white/5 shadow-[0_0_20px_rgba(255,0,0,0.1)] rounded-2xl md:rounded-3xl px-3.5 py-2.5 md:px-6 md:py-3">
                    ...
                    <div className="w-full max-w-xl md:max-w-2xl text-xs md:text-base leading-relaxed font-mono mt-1 text-white/90 border border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.08)] rounded-2xl md:rounded-3xl p-4 md:p-5">
                        <ScrambleText
